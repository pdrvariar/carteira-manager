...
<head>
    ...
    <title><?php echo $title ?? 'Carteira Manager'; ?></title>
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top shadow-lg">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/index.php?url=<?= obfuscateUrl('dashboard') ?>">
                ...
                CARTEIRA<span class="fw-light">MANAGER</span>
            </a>
    ...
    <footer class="footer mt-auto py-3 bg-white border-top">
        <div class="container text-center">
            <span class="text-muted small">Carteira Manager &copy; <?php echo date('Y'); ?></span>
        </div>
    </footer>
